...
var InitialLoaderComponent = function InitialLoaderComponent(props) {
  return _react2.default.createElement(
    "div",
    { className: undefined.props.bemBlocks.item().mix(undefined.props.bemBlocks.container("item")) },
...
var NoHitsDisplay = function NoHitsDisplay(props) {
  var _props = undefined.props,
      bemBlocks = _props.bemBlocks,
      query = _props.query,
      suggestion = _props.suggestion,
      noResultsLabel = _props.noResultsLabel;
...
var NoHitsErrorDisplay = function NoHitsErrorDisplay(props) {
  var _props2 = undefined.props,
      errorLabel = _props2.errorLabel,
      bemBlocks = _props2.bemBlocks,
      resetSearchFn = _props2.resetSearchFn,
      tryAgainLabel = _props2.tryAgainLabel;
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(_searchkit.NoHits, {
                component: NoHitsDisplay,
                errorComponent: NoHitsErrorDisplay,
                translations: {
                  "NoHits.NoResultsFound": "Товаров по запросу {query} не найденно",
...
//# sourceMappingURL=0.cf90a6dd7a11a0748179.hot-update.js.map