...
var MovieHit = function (_React$Component) {
  ...
  _createClass(MovieHit, [{
    ...
    value: function render() {
      ...
      var url = "http://127.0.0.1:8000/tablets/" + result._source.slug;
      return _react2.default.createElement(
        "div",
        { className: this.props.bemBlocks.item().mix(this.props.bemBlocks.container("item")) + " col s4 m12", key: result._id },
        _react2.default.createElement(
          "a",
          { href: url, target: "_blank" },
          _react2.default.createElement("img", { className: this.props.bemBlocks.item("poster"), src: result._source.image, width: "100", height: "140" }),
          _react2.default.createElement(
            "div",
...
//# sourceMappingURL=0.36d9300b81be7bd87303.hot-update.js.map